...
<title>Expense Management - Add SubCategory</title>
</head>
<body class="text-center1">
	<form class="form-add" action="/addSubCategory.htm" method="post">
		<!-- <img class="mb-4" src="https://getbootstrap.com/docs/4.0/assets/brand/bootstrap-solid.svg" alt="" width="72"
			height="72">-->

		<h1 class="h3 mb-3 col-sm-6 font-weight-normal mx-auto">Add Category</h1>
	...
	<script type="text/javascript">
		function submitForm(type) {
			if (type === 'add') {
				...
				$('.form-add').attr('action', '/addSubCategory.htm');
			} else if (type === 'cancel') {
				$('input[text]').removeAttr('required');
				$('.form-add').attr('method', 'GET');
				$('.form-add').attr('action', '/subCategories.htm');
			}
		}
	</script>
</body>
